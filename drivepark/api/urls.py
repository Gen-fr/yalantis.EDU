...
urlpatterns = [
  ...
  #vehicles
    ...
    path('vehicles/vehicle/', views.VehicleList.as_view(), name='vehicle-filter'),
    # path('vehicles/set_driver/<str:pk>',  views.VehicleSet.as_view(), name='vehicle-setdriver'),
    path('vehicles/set_driver/<str:pk>',  views.vehicleSetDriver, name='vehicle-setdriver')
